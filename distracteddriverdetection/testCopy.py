...
parser.add_argument("-hw", "--hog_windows", default="no", help="extract HOG features from a sliding window")
...
parser.add_argument("-e", "--expressions", default="'a','b','c','d','e','f','g','h','i','j'",
                    help="choose the faciale expression you want to use: 0=Angry, 1=Disgust, 2=Fear, 3=Happy, 4=Neutral, 5=Sad, 6=Surprise")
